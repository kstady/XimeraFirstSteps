...
%% Note: since ximeraLatex >= 2024-11-07, file xmPreamble.tex is included AUTOMATICALLY if present
%% explicit use of \input{preamble} is in most cases no longer needed
